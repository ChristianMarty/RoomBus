...
//**********************************************************************************************************************
static inline uint8_t cobs_encode(uint8_t *destination, const uint8_t *source, uint16_t source_length)
{
...
//**********************************************************************************************************************
static inline uint8_t cobs_decode(uint8_t *destination, const uint8_t *source, uint16_t length)
{
